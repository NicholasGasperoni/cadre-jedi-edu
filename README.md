...
- Hybrid ensemble-variational data assimilation (3DEnVar, 4DEnVar):q
- Local Particle Filter (LPF) for nonlinear, nongaussian DA
- Examination of spatial and time-based flow dependence, and their effects on analyses
- Basic qualitative and quantitative diagnostics/visualizations (i.e. RMSD, spread, sawtooth diagrams)
