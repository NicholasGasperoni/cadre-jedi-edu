...
This repository contains the data assimilation (DA) tutorial, JEDI-edu, further developed by the **Consortium for Advanced Data Assimilation Research and Education (CADRE, <https://ucadre.org/>)**.  JEDI-edu uses the next-generation **Joint Effort for Data assimilation Integration (JEDI)** system (https://www.jcsda.org/jcsda-project-jedi), and is appropriate for upper-level undergraduate and graduate students within the earth science disciplines. 
