...
parser_qg_fields.add_argument("--fieldmax", help="Set scale of the plots (using streamfunction value)")
parser_qg_fields.add_argument("--scalemax", action="store_true", help="Force the wind vector scale to scale with the fieldmax")
parser_qg_fields.add_argument("--plotObsLocations", help="Specify an observation file to plot the obs positions")
parser_qg_fields.add_argument("--plotObsValues", help="Specify an observation file to plot the obs locations colored by y-hx value")
parser_qg_fields.add_argument("--plothofx", dest="plothofx", action="store_true", help="Plot hofx, must be accompanied with --plotObsValues")
parser_qg_fields.add_argument("--plotwind", dest="plotwind", action="store_true", help="Plot wind")
parser_qg_fields.add_argument("--plotstream", dest="plotstream", action="store_true", help="Overlay streamfunction contours")
